...
public class DatabaseConnection extends BaseDatabaseConnection {
    ...
    public static class Builder {
        ...
        public DatabaseConnection build() {
            return new DatabaseConnection(this.service, this.host, this.port, this.dbName, this.user, this.pass);
        }

    }

    public DatabaseConnection(DatabaseService service, String host, int port, String dbName, String user, String pass) {
        super("jdbc:" + service.name().toLowerCase() + "://" + host + (port >= 0 ? ":" + port : "") + "/" + dbName, dbName, service);
